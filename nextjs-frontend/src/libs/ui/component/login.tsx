    ...
    <div className="grid grid-rows-2 md:grid-cols-2 gap-y-4 gap-x-4 px-40"
      ...
      <div className="grid grid-rows-7 md:grid-cols-1 gap-y-4 gap-x-4 px-40"
        style={{ backgroundColor: "#ffffff" }}>  
            ...
            <div>
                or 
                <Link className="underline px-2" href="/forgotpassword">Forgot password</Link>
            </div>
            <div>
                or &nbsp;
            <button type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"            
            onClick={() => signIn()}>Sign In with OAuth Provider</button>
            </div>
        </div>
