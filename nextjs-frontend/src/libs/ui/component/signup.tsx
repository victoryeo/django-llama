    ...
    <div className="grid grid-rows-2 md:grid-cols-2 gap-y-4 gap-x-4 px-40"
      ...
      <div>
        ...
        style={{ backgroundColor: "#ffffff" }}>  
            ...
            <div>
                <label htmlFor="full_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">First name</label>
            ...
            <div>
                ...
                <Link className="underline px-2" href="/login">Log in</Link>
            </div>
        </div>
      </div>
    </div>
